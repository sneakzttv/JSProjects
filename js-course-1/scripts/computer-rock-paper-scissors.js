...
// Get body to see if we're typing on the page, adding event as parameter allows event listener to save the key in the chosen parameter
document.body.addEventListener('keydown', (event) => {
  //console.log(event.key);
  // Allows game play via keys r, p & s
  if (event.key === 'r')
  {
    playGame('rock');
  } else if (event.key === 'p') {
